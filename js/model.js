...
class Model {
    ...
    setList() {
        ...
        if (this.list === 'birds') {
            ...
            birdlist.forEach(species => allowed_IDs.push(labels.indexOf(species)))
    ...
    makeSpectrogram(audioBuffer) {
        ...
        */
        ...
        // Add channel axis
        return tf.expandDims(spectrogram, -1);
