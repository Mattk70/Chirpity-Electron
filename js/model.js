...
class Model {
    ...
    async predictChunk(chunk, index, fileStart) {
        ...
        tf.tidy(() => {
                ...
                let [primary, secondary, tertiary] = indices.dataSync();
                let [score, score2, score3] = values.dataSync();
