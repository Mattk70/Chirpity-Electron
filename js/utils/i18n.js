...
const Toasts = { // UI.js
    ...
    sv: {
        ...
        listNotFound: 'Den anpassade listfilen: ${file} kunde inte hittas, <b class="text-danger">inga detektioner kommer att visas</b>.',        leafletError: 'Ett fel uppstod vid visning av kartan: ${error}',
