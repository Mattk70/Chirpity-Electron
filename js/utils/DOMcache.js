...
const DOM = {
  ...
  get databaseLocationSelect() { return this._databaseLocationSelect ??= document.getElementById("database-location-select") },
  get clearDatabaseLocation() { return this._clearDatabaseLocation ??= document.getElementById("clear-database-location") },
